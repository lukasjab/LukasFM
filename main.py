...
while True:
    ...
    try:
        if command == "help":
            ...
            os.rename(workingDirectory + "/" + old_name, workingDirectory + "/" + new_name)
        elif command == "exit":
            break
        else:
            print("Invalid command.")
    except:
        print("An error has occurred with your command and it did not run successfully. Please try again and contact the project maintainer if the issue persists.")